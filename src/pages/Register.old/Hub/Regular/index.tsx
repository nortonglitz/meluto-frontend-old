...
import { At, CardAccountDetails, Lock } from 'mdi-material-ui'
import Step from '../Step'

interface HubRegularProps {
...
const HubRegular: React.FC<HubRegularProps> = ({ setStep, emailVerified, nameCreated, passwordCreated }) => {
  useEffect(() => {
  ...
  return (
    <Fade in>
      <Box>
        <Typography variant="h6">Cadastro - Pessoa Física</Typography>

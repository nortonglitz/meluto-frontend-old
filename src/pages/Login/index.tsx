...
import { Grid, Fade, Box, TextField, Typography, Button, Divider, Hidden, Snackbar, Alert, AlertColor, CircularProgress } from '@mui/material'
        ...
        <Grid container justifyContent="center">
          <Grid item xs={12} md={5} lg={4} sx={{ display: 'flex', justifyContent: 'center' }}>
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', maxWidth: '300px' }}>
              <img src={`${bucket}/illustrations/login.svg`} width={250} alt="Login"/>
          ...
          <Hidden mdDown>
            ...
            <Grid item xs={5} md={5} lg={4} sx={{ display: 'flex', mt: 10, justifyContent: 'center' }}>
              <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%', maxWidth: '300px' }}>
                <img src={`${bucket}/illustrations/register.svg`} width={200} alt="Cadastrar"/>
